...
import de.htwg.se.scrabble.model.gameComponent.MatrixInterface
import de.htwg.se.scrabble.model.gameComponent.square.{LetterSquareFactory, ScrabbleSquare, StandardSquareFactory, WordSquareFactory}
