...
import de.htwg.se.scrabble.model.gameComponent.scoring.{EnglishScoringSystem, FrenchScoringSystem, GermanScoringSystem, ItalianScoringSystem, ScoringSystem}
